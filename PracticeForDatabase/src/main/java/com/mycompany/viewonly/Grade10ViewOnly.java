...
import java.util.*;
import java.sql.*;
public class Grade10ViewOnly {
    static int counter = 1;
    public static void g10viewonly(){
        ...
        while(repeat){
            ...
            if(choice.equals("1")){
                try (Connection connection = DatabaseUtil.conn()){
                    if (connection != null) {
                        String viewQuery = "SELECT * FROM tb_g10hope";
                ...
                try (Connection connection = DatabaseUtil.conn()){
                    if (connection != null) {
                        String viewQuery = "SELECT * FROM tb_g10faith";
                        PreparedStatement preparedStatement = connection.prepareStatement(viewQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()){
                    if (connection != null) {
                        String viewQuery = "SELECT * FROM tb_g10loyalty";
                        PreparedStatement preparedStatement = connection.prepareStatement(viewQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()){
                    if (connection != null) {
                        String viewQuery = "SELECT * FROM tb_g10charity";
                        PreparedStatement preparedStatement = connection.prepareStatement(viewQuery);
                        ResultSet resultSet = preparedStatement.executeQuery();
