...
import java.sql.*;
import java.util.*;
public class Grade7Simplicity {
    static int counter = 1;
    public static void Grade7Simplicity(){
        ...
        while(repeat){
            ...
            if(choice.equals("1")){
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7simplicity SET monday = ? WHERE monday = ? AND sched_id = ?";
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7simplicity SET tuesday = ? WHERE tuesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7simplicity SET wednesday = ? WHERE wednesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7simplicity SET thursday = ? WHERE thursday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7simplicity SET friday = ? WHERE friday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
