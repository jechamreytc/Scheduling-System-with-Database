...
import java.sql.*;
import java.util.*;
public class Grade7Obedience {
    static int counter = 1;
    public static void Grade7Obedience(){
        ...
        while(repeat){
            ...
            if(choice.equals("1")){
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7obedience SET monday = ? WHERE monday = ? AND sched_id = ?";
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7obedience SET tuesday = ? WHERE tuesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7obedience SET wednesday = ? WHERE wednesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7obedience SET thursday = ? WHERE thursday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g7obedience SET friday = ? WHERE friday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
