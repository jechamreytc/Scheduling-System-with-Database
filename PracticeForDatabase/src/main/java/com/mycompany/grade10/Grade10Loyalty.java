...
import java.sql.*;
import java.util.*;
public class Grade10Loyalty {
    static int counter = 1;
    public static void Grade10Loyalty(){
        ...
        while(repeat){
            ...
            if(choice.equals("1")){
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g10loyalty SET monday = ? WHERE monday = ? AND sched_id = ?";
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g10loyalty SET tuesday = ? WHERE tuesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g10loyalty SET wednesday = ? WHERE wednesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g10loyalty SET thursday = ? WHERE thursday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g10loyalty SET friday = ? WHERE friday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
