...
import java.sql.*;
import java.util.*;
public class Grade9Courage {
    static int counter = 1;
    public static void Grade9Courage(){
        ...
        while(repeat){
            ...
            if(choice.equals("1")){
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g9courage SET monday = ? WHERE monday = ? AND sched_id = ?";
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g9courage SET tuesday = ? WHERE tuesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g9courage SET wednesday = ? WHERE wednesday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g9courage SET thursday = ? WHERE thursday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
                ...
                try (Connection connection = DatabaseUtil.conn()) {
                    String updateQuery = "UPDATE tb_g9courage SET friday = ? WHERE friday = ? AND sched_id = ?";
                    PreparedStatement preparedStatement = connection.prepareStatement(updateQuery);
